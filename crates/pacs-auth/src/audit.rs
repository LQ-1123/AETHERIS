...
impl Action {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PasswordResetApproved => "password_reset_approved",
            Self::PasswordResetRejected => "password_reset_rejected",
            ...
            Self::ExamRequestUpdated => "exam_request_updated",
            Self::ExamRequestBound => "exam_request_bound",
